...
runId: 2026-05-14-repair-loop-dogfood
mode: validation
profile: repair-loop
adapterKind: llm-api
...
```text
python -B scripts/update_orchestration_state.py --root top/orchestration/top-skill-2-repair-loop-dogfood/2026-05-14-repair-loop-dogfood
```
