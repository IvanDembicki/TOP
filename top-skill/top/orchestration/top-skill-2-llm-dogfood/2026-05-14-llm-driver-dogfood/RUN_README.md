...
workflowId: top-skill-2-llm-dogfood
runId: 2026-05-14-llm-driver-dogfood
mode: maintenance
profile: llm-smoke
adapterKind: llm-api
...
```text
python -B scripts/update_orchestration_state.py --root top/orchestration/top-skill-2-llm-dogfood/2026-05-14-llm-driver-dogfood
```
...
python -B scripts/top_protocol_runner.py runner/runner-workflow.json --root top/orchestration/top-skill-2-llm-dogfood/2026-05-14-llm-driver-dogfood --execute-passes --execute-hard-checks --accept-external-runner-evidence --report-out runner/runner-report.json
```
