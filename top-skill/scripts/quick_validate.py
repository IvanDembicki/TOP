...
def check_required_phrases(root):
    checks = [
        ...
        ("SKILL.md", "enterprise-scale codebases"),
        ("SKILL.md", "typed node contracts"),
        ...
        ("README.md", "enterprise-scale codebases"),
        ("README.md", "raw code editing"),
        ("AI_PRELOAD_CONTEXT.md", "O(n²)"),
        ("AI_PRELOAD_CONTEXT.md", "interface/contract-governed node generation"),
        ("AI_PRELOAD_CONTEXT.md", "enterprise-scale codebases"),
