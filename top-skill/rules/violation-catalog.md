...
| CORE-019 | Content/View semantic injection | Content/View constructor or runtime props/render channel receives data, callbacks, flags, stores, services, child components, slots, builders, prebuilt fragments, platform child views, child view handles, arbitrary props, or a dummy zero-access object instead of exactly one narrow owner access interface implemented by the owning controller. |
